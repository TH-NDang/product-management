...
def create_new_project(project: ProjectCreate, session: SessionDep, current_user=Depends(get_current_user)):
...
def get_project(project_id: str, session: SessionDep, current_user=Depends(get_current_user)):
...
def update_existing_project(project_id: str, project: ProjectUpdate, session: SessionDep):
